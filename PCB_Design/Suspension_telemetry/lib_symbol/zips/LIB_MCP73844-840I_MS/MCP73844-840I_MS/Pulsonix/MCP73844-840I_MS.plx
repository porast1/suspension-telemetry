...
(library Library_1
	...
	(compDef "MCP73844-840I_MS" (originalName "MCP73844-840I_MS") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "DRV") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VBAT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VSS") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "TIMER") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://ww1.microchip.com/downloads/en/DeviceDoc/21823D.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "MCP73844-840I_MS.stp")
