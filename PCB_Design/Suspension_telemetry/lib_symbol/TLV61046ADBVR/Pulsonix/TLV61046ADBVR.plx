...
(library Library_1
	...
	(compDef "TLV61046ADBVR" (originalName "TLV61046ADBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix PS)
		...
		(compPin "1" (pinName "SW") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "2" (pinName "GND") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "3" (pinName "FB") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "6" (pinName "VIN") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "5" (pinName "VOUT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "4" (pinName "EN") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tlv61046a.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TLV61046ADBVR.stp")
