...
(library Library_1
	...
	(compDef "MCP73114-0NSI_MF" (originalName "MCP73114-0NSI_MF") (compHeader (numPins 11) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "VBAT_1") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "VBAT_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "10" (pinName "PROG") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "VSS_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VSS_1") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "STAT") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "NC_2") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/DeviceDoc/20002183E.pdf")
		(attr "Height" "1 mm")
	)
