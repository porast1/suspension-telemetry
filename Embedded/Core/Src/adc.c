...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA2     ------> ADC2_IN2
    */
    HAL_GPIO_DeInit(GPIOC, BRAKE_SENSOR_RIGHT_Pin|BRAKE_SENSOR_LEFT_Pin|TRAVEL_SENSOR_FRONT_Pin|TRAVEL_SENSOR_REAR_Pin);

    HAL_GPIO_DeInit(GPIOA, PRESSURE_SENSOR_FRONT_Pin|PRESSURE_SENSOR_REAR_Pin);
